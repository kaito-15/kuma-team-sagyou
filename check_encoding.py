...
try:
    with open('c:/2年秋学期/Data/antigravity/data/bear_killed_count.csv', 'r', encoding='utf-8') as f:
...
try:
    with open('c:/2年秋学期/Data/antigravity/data/bear_killed_count.csv', 'r', encoding='shift_jis') as f:
